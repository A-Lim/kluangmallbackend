...
use App\Http\Traits\HasSocial;
use App\Http\Traits\CustomQuery;
use App\Http\Traits\EnvTimezone;

class User extends Authenticatable {
    use Notifiable, HasApiTokens, HasUserGroups, HasSocial, CustomQuery, EnvTimezone;

    protected $fillable = ['name', 'email', 'password', 'member_no', 'phone', 'gender', 'date_of_birth', 'points', 'avatar', 'device_token', 'email_verified_at', 'is_social', 'status', 'otp', 'otp_token', 'otp_expiry'];
